...
public class ListPlayerAdapter extends RecyclerView.Adapter<ListPlayerAdapter.RecyclerViewHolder> {
    ...
    public ListPlayerAdapter(Context context, ArrayList<Player> listPlayer, PositionClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull RecyclerViewHolder holder, int position) {
        if (position == 0) {
            holder.playerName.setText("New");
            holder.playerImg.setImageResource(R.drawable.ic_add);
